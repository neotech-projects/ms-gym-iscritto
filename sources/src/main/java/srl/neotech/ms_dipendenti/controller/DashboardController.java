...
public class DashboardController {
    ...
    public ResponseEntity<Map<String, Object>> getStatistiche(@RequestParam(name = "utenteId") Integer utenteId) {
        return ResponseEntity.ok(dashboardService.getStatistiche(utenteId));
    }
}